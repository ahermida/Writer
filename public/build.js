...
frontPageActions.inputError = function (message) {
  ...
  if (found) {
    ...
    _w2.default.insert(_w2.default.mFindId('formInputWrapperInner'), _w2.default.html('\n      <div class="success" id="notification">' + message + '</div>\n    '));
  }
};
...
frontPageActions.nextInputItemLogin = function () {
  var formGuide = _w2.default.mFindId('formGuide');
  var form = _w2.default.mFindId('formInputLogin');
  switch (_store2.default.frontPage.targetItem) {
    case "username":
      _store2.default.frontPage.targetItem = "password";
      form.type = 'password';
  ...
  _w2.default.post('http://' + location.host + '/users/make').attach({
    ...
    if (err) {
      ...
      if (res.body.success) {
        ...
        var formGuide = _w2.default.mFindId('formGuide');
        var form = _w2.default.mFindId('formInput');
        form.placeholder = "writer@villanova.edu";
        _store2.default.frontPage.targetItem = "username";
        formGuide.textContent = "Villanova Email:";
...
var frontPage = function frontPage() {
  ...
  _w2.default.addEvent('keyup', 'formInput', function (event) {
    ...
    //handle keypresses
    if (event.keyCode === 13) {
      var evaluation = _frontPageActions2.default.parseItem(event.target.value.trim());
      ...
      _w2.default.findId('notification').className = "success";
    }
    if (!_store2.default.frontPage.inputNote) {
  ...
  _w2.default.addEvent('click', 'notification', function (event) {
    var item = _w2.default.findId('notification');
    if (item) {
      _w2.default.remove(item);
    }
  });
